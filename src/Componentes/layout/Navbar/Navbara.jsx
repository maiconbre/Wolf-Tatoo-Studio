          ...
          <div className='w3-top' id='home'>
              <div className='w3-bar  w3-card w3-left-align w3-large heeder-large-screen' >
                  ...
                  <div >
                      ...
                      <a href='#events' className='w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-black'>Sobre</a>
              ...
              <div id='navDemo' className='w3-bar-block  w3-hide w3-hide-large w3-hide-medium w3-large'>
                  <a href='#about' className='w3-bar-item w3-button w3-padding-large' >Home</a>
                  <a href='#games' className='w3-bar-item w3-button w3-padding-large' >Studios</a>
                  <a href='#shop' className='w3-bar-item w3-button w3-padding-large' >Agendamento</a>
                  <a href='#events' className='w3-bar-item w3-button w3-padding-large' >Sobre</a>
